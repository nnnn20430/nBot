...
module.exports = Create_nBot_instance;
...
function initBotV(nBot) {
	var options = nBot.publicData.options;
	var botV = nBot.publicData.botVariables;
	var botF = nBot.publicData.botFunctions;
